...
export namespace Configuration {
  ...
  export function fromEnvironment(
    ...
    if (envVariables.SEMGREP_ADMIN_JWT_ACCESS_TOKEN) {
      config.semgrepAdminJwtCredentials = {
        accessToken: envVariables.SEMGREP_ADMIN_JWT_ACCESS_TOKEN,
      };
    }

    if (envVariables.SEMGREP_JWT_ACCESS_TOKEN) {
      config.semgrepJwtCredentials = {
        accessToken: envVariables.SEMGREP_JWT_ACCESS_TOKEN,
      };
    }

    if (envVariables.SEMGREP_WEB_TOKEN_ACCESS_TOKEN) {
      config.semgrepWebTokenCredentials = {
        accessToken: envVariables.SEMGREP_WEB_TOKEN_ACCESS_TOKEN,
      };
    }
